 ...
 * TeamBox usa il colore della squadra, con il caposquadra come intestazione.
 */
...
export function TeamBox({
  ...
  return (
    <div
      className="rounded-lg border overflow-hidden min-w-[220px]"
      style={{ borderColor: hexToRgba(color, 0.6), background: hexToRgba(color, 0.06) }}
    >
      <div
  ...
  return (
    <div className="rounded-xl border border-border bg-card/40 p-3">
      ...
      >
        ...
        <span className="ml-auto text-[10px] text-muted-foreground">{collapsed ? 'espandi' : 'riduci'}</span>
      </button>
