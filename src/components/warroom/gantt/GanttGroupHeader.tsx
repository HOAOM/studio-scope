...
export function GanttGroupHeader({ group, rows, isCollapsed, onToggle }: Props) {
  ...
  return (
    ...
    >
      <div className="sticky left-0 z-20 flex items-center gap-2 px-3 bg-card border-r border-border/20" style={{ width: LEFT_PANEL_WIDTH, backgroundColor: 'hsl(var(--card))' }}>
        {isCollapsed
