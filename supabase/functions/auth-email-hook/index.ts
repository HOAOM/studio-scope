...
const SAMPLE_PROJECT_URL = "https://studio-scope.lovable.app"
...
async function handleWebhook(req: Request): Promise<Response> {
  ...
  console.log('Received auth event', { emailType, email: payload.data.email, run_id, url: payload.data.url, siteUrl: payload.data.site_url })
