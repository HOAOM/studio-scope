/**
 * run-migration-secfix7 — revoke anonymous EXECUTE on peek_org_invite.
 * The invite preview now goes through the peek-invite edge function (service role),
 * so anonymous visitors no longer need direct RPC access. Idempotent. Admin-only.
 */
